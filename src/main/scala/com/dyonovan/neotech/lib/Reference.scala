...
object Reference {
    ...
    final val VERSION      = "3.0.2"//@VERSION@"
    final val DEPENDENCIES = "after:tconstruct;required-after:Forge@[11.16.0.1811,);required-after:bookshelfapi@[3.0.1,);" //required-after:mcmultipart@[1.0.7,)
