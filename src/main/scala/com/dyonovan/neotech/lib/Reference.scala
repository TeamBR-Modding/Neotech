...
object Reference {
    ...
    final val VERSION      = "3.0.4"//@VERSION@"
    final val DEPENDENCIES = "after:tconstruct;required-after:Forge@[11.16.0.1836,);required-after:bookshelfapi@[3.0.3,);" //required-after:mcmultipart@[1.0.7,)
