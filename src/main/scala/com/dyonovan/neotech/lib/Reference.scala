...
object Reference {
    ...
    final val VERSION      = "3.0.6"//@VERSION@"
    final val DEPENDENCIES = "after:tconstruct;required-after:Forge@[11.16.0.1845,);required-after:bookshelfapi@[3.0.4,);" //required-after:mcmultipart@[1.0.7,)
