...
object Reference {
    ...
    final val VERSION      = "2.4.1"//@VERSION@"
    final val DEPENDENCIES = "after:tconstruct;required-after:Forge@[11.15.1.1747,);required-after:bookshelfapi@[2.3.6,);" //required-after:mcmultipart@[1.0.7,)
