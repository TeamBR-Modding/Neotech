        ...
        components += new GuiComponentFluidTank(38, 18, 18, 60, tileEntity.tanks(tileEntity.INPUT_TANK_1)) {
            override def getDynamicToolTip(x: Int, y: Int): ArrayBuffer[String] = {
                ...
                buffer += (if(tileEntity.tanks(tileEntity.INPUT_TANK_1).getFluid != null)
                    ...
                    GuiColor.RED + "Empty")
                buffer += NumberFormat.getNumberInstance(Locale.forLanguageTag(Minecraft.getMinecraft.gameSettings.language)).format(tileEntity.tanks(tileEntity.INPUT_TANK_1).getFluidAmount) + " / " +
                        NumberFormat.getNumberInstance(Locale.forLanguageTag(Minecraft.getMinecraft.gameSettings.language)).format(tileEntity.tanks(tileEntity.INPUT_TANK_1).getCapacity) + " mb"
                buffer
            }
        }
        ...
        components += new GuiComponentFluidTank(60, 18, 18, 60, tileEntity.tanks(tileEntity.INPUT_TANK_2)) {
            override def getDynamicToolTip(x: Int, y: Int): ArrayBuffer[String] = {
                ...
                buffer += (if(tileEntity.tanks(tileEntity.INPUT_TANK_2).getFluid != null)
                    ...
                    GuiColor.RED + "Empty")
                buffer += NumberFormat.getNumberInstance(Locale.forLanguageTag(Minecraft.getMinecraft.gameSettings.language)).format(tileEntity.tanks(tileEntity.INPUT_TANK_2).getFluidAmount) + " / " +
                        NumberFormat.getNumberInstance(Locale.forLanguageTag(Minecraft.getMinecraft.gameSettings.language)).format(tileEntity.tanks(tileEntity.INPUT_TANK_2).getCapacity) + " mb"
                buffer
            }
        }
