package com.teambrmodding.neotech.pipes.tiles.structure

import com.teambrmodding.neotech.pipes.blocks.{BlockPipe, BlockPipeSpecial, PipeProperties}
import com.teambrmodding.neotech.pipes.types.SimplePipe
...
/**
  ...
  */
class StructurePipe extends TileEntity with SimplePipe {
    /**
