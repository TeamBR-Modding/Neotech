...
import com.teambrmodding.neotech.client.{ItemRenderManager, ModelLoaderHelper}
import com.teambrmodding.neotech.common.metals.blocks.{BlockFluidMetal, BlockMetalOre}
...
object MetalManager {
    ...
    def registerMetal(metalName: String, miningLevel: Int, color: Int, fluidColor: Int,
        ...
        if (hasFluid && !inTinkers(metalNameBase))
