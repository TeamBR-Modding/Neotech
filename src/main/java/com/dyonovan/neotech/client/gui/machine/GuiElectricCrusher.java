...
import com.dyonovan.neotech.common.container.machine.ContainerElectricCrusher;
...
public class GuiElectricCrusher extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        final String invTitle = StatCollector.translateToLocal("tile.neotech:electricCrusher.name");
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        tile = (TileElectricCrusher) mc.theWorld.getTileEntity(tile.getPos());
